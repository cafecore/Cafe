...
/* Cafe GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CAFE"
#define QAPP_ORG_DOMAIN "cafecoin.coffee"
#define QAPP_APP_NAME_DEFAULT "Cafe-Qt"
#define QAPP_APP_NAME_TESTNET "CAFE-Qt-testnet"
