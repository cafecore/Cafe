                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CAFE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CAFE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cafe: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CAFE Core"), this);
    aboutAction->setStatusTip(tr("Show information about CAFE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CAFE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CAFE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CAFE addresses"));
    ...
    openAction->setStatusTip(tr("Open a CAFE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CAFE Core help message to get a list with possible CAFE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CAFE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CAFE network", "", count));
}
...
{
    QString strTitle = tr("CAFE Core"); // default title
