...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CAFE features */
        {"cafe", "masternode", &masternode, true, true, false},
        {"cafe", "listmasternodes", &listmasternodes, true, true, false},
        {"cafe", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cafe", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cafe", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cafe", "masternodedebug", &masternodedebug, true, true, false},
        {"cafe", "startmasternode", &startmasternode, true, true, false},
        {"cafe", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cafe", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cafe", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cafe", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cafe", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cafe", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cafe", "mnbudget", &mnbudget, true, true, false},
        {"cafe", "preparebudget", &preparebudget, true, true, false},
        {"cafe", "submitbudget", &submitbudget, true, true, false},
        {"cafe", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cafe", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cafe", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cafe", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cafe", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cafe", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cafe", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cafe", "checkbudgets", &checkbudgets, true, true, false},
        {"cafe", "mnsync", &mnsync, true, true, false},
        {"cafe", "spork", &spork, true, true, false},
        {"cafe", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cafe", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> cafe-cli " + methodname + " " + args + "\n";
}
