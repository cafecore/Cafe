...
RESOURCES += src/qt/cafe.qrc src/qt/cafe_locale.qrc

TRANSLATIONS += src/qt/locale/cafe_bg.ts \
                src/qt/locale/cafe_de.ts \
                src/qt/locale/cafe_en.ts \
                src/qt/locale/cafe_es.ts \
                src/qt/locale/cafe_fi.ts \
                src/qt/locale/cafe_fr.ts \
                src/qt/locale/cafe_it.ts \
                src/qt/locale/cafe_ja.ts \
                src/qt/locale/cafe_pl.ts \
                src/qt/locale/cafe_pt.ts \
                src/qt/locale/cafe_ru.ts \
                src/qt/locale/cafe_sk.ts \
                src/qt/locale/cafe_sv.ts \
                src/qt/locale/cafe_vi.ts \
                src/qt/locale/cafe_zh_CN.ts \
                src/qt/locale/cafe_zh_TW.ts
