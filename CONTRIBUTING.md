Contributing to Cafe Core
============================

The Cafe Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cafe Core project, and is not to be
confused with overall Cafe Network Protocol consensus changes.

Whether a pull request is merged into Cafe Core rests with the project merge
...
Patches that change Cafe consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cafe consensus, it must have been
...
The project leader is the release manager for each Cafe Core release.
